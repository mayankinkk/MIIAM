...
-- Run separately if tables already exist: check supabase/migrations/service_bookings.sql
-- ─────────────────────────────────────────────────────────────────────────────
...
-- Open RLS policies (service_role client bypasses RLS anyway; these allow anon reads)
CREATE POLICY IF NOT EXISTS "Allow full access to service_bookings" ON service_bookings FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow full access to service_providers" ON service_providers FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow full access to service_categories" ON service_categories FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Allow full access to service_items" ON service_items FOR ALL USING (true) WITH CHECK (true);
