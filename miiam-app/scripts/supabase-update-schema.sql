...
-- Copy and run this script in your Supabase Dashboard SQL Editor (https://supabase.com)
...
-- Reload PostgREST Schema Cache (important for REST clients to recognize changes immediately)
