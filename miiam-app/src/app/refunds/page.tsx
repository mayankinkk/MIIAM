...
export default function RefundsPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface-container-lowest)]">
          ...
          <main className="lg:col-span-9 mt-8 lg:mt-0">
            <div className="bg-[var(--color-surface-container-lowest)] rounded-2xl shadow-sm p-6 sm:p-8 lg:p-10">
              ...
              <div className="space-y-8">
                {/* Overview */}
                <section id="overview">
                  <h2 className="text-xl font-bold text-[var(--color-on-surface)] mb-4">1. Overview</h2>
                ...
                <section id="food">
                  ...
                  <div className="space-y-4 text-[var(--color-on-surface-variant)]">
                    ...
                    <p className="mt-4"><strong className="text-[var(--color-on-surface)]">2.2 Eligible for partial refund:</strong></p>
                    <ul className="list-disc pl-6 space-y-1">
                    ...
                    <p className="mt-4"><strong className="text-[var(--color-on-surface)]">2.3 Not eligible for refund:</strong></p>
                    <ul className="list-disc pl-6 space-y-1">
                ...
                <section id="services">
                  ...
                  <div className="space-y-4 text-[var(--color-on-surface-variant)]">
                    ...
                    <p className="mt-4"><strong className="text-[var(--color-on-surface)]">3.2 Eligible for partial refund:</strong></p>
                    <ul className="list-disc pl-6 space-y-1">
                    ...
                    <p className="mt-4"><strong className="text-[var(--color-on-surface)]">3.3 Not eligible for refund:</strong></p>
                    <ul className="list-disc pl-6 space-y-1">
                ...
                {/* Processing Timeline */}
                <section id="timeline">
                  <h2 className="text-xl font-bold text-[var(--color-on-surface)] mb-4">5. Payment Method Refund Timelines</h2>
                ...
                {/* How to Request */}
                <section id="howto">
                  <h2 className="text-xl font-bold text-[var(--color-on-surface)] mb-4">6. How to Request a Refund</h2>
                  <ul className="list-disc pl-6 space-y-2 text-[var(--color-on-surface-variant)]">
                    ...
                    <li>WhatsApp us at 99578 73472</li>
                  </ul>
                  <p className="mt-4 text-[var(--color-outline)] text-sm">
                ...
                {/* Disputes */}
                <section id="disputes">
                  <h2 className="text-xl font-bold text-[var(--color-on-surface)] mb-4">8. Disputes & Escalations</h2>
                ...
                {/* Fraud */}
                <section id="fraud">
                  <h2 className="text-xl font-bold text-[var(--color-on-surface)] mb-4">9. Fraud & Misuse</h2>
                  <p className="text-[var(--color-on-surface-variant)]">
                ...
                {/* Contact */}
                <section id="contact">
                  <h2 className="text-xl font-bold text-[var(--color-on-surface)] mb-4">10. Contact</h2>
                  <div className="bg-[var(--color-surface-subtle)] rounded-xl p-6">
      ...
      {/* Footer */}
      <footer className="bg-[var(--color-surface-container-lowest)] border-t border-[var(--color-border-subtle)] py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
