...
export default function OnboardingPage() {
  return (
    <div className="bg-[var(--color-surface-container-lowest)] text-[var(--color-on-surface)] min-h-screen">
      ...
      <section className="min-h-screen bg-[var(--color-surface-container)] flex flex-col items-center justify-center px-6 py-20 relative">
        <div className="max-w-6xl w-full">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-[var(--color-on-surface)] mb-4">One App, Two Worlds.</h2>
      ...
      <section className="min-h-screen flex items-center justify-center px-6 relative">
        <div className="max-w-xl w-full text-center">
          ...
          <p className="text-[var(--color-on-surface-variant)] text-lg leading-relaxed mb-10 max-w-md mx-auto">
          ...
          <div className="mt-12 flex items-center justify-center gap-2 text-[var(--color-on-surface-variant)] text-xs">
