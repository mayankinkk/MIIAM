      ...
      <main className="pt-[72px] overflow-x-hidden">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link href="/app/food" className="md:col-span-2 group relative overflow-hidden rounded-2xl bg-white shadow-[0_4px_24px_rgba(0,0,0,0.06)] border border-slate-100 hover:shadow-[0_8px_40px_rgba(0,0,0,0.1)] transition-shadow duration-500">
