      ...
      <main className="pt-[72px] overflow-x-hidden">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Food Card */}
            <div className="md:col-span-2 group relative overflow-hidden rounded-2xl bg-white shadow-[0_4px_24px_rgba(0,0,0,0.06)] border border-slate-100 hover:shadow-[0_8px_40px_rgba(0,0,0,0.1)] transition-shadow duration-500">
              <div className="aspect-[16/9] overflow-hidden">
                <img
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                  src="/images/food_pizza.png"
                  alt="Wood-fired artisan pizza"
                  onError={(e) => { (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800&q=80"; }}
                />
              </div>
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-slate-800">Pizzeria d&apos;Autore</h3>
                  ...
                  <Link href="/app/food" className="bg-[#ba001c] p-3 rounded-xl text-white hover:bg-[#a40017] active:scale-90 transition-all shadow-lg shadow-[#ba001c]/20">
