...
export default function PartnerLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      {/* Sidebar */}
      <aside className="w-64 bg-[var(--color-surface-container-lowest)] border-r border-slate-200 fixed h-full z-20 flex-col hidden md:flex">
      ...
      <main className="flex-1 md:ml-64 relative">
        <header className="md:hidden bg-[var(--color-surface-container-lowest)] border-b border-slate-200 px-4 py-3 flex items-center justify-between sticky top-0 z-30">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[var(--color-surface-container-lowest)] border-b border-slate-200 px-4 py-2 relative z-20">
