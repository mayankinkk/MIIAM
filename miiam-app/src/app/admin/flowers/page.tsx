    ...
    <div className="min-h-screen bg-[var(--color-surface-subtle)]">
      <main className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/admin/flowers/orders" className="bg-[var(--color-surface-container-lowest)] p-6 rounded-2xl border border-[var(--color-border-subtle)] hover:border-[var(--color-primary)] hover:shadow-lg transition-all group">
          ...
          <Link href="/admin/flowers/partners" className="bg-[var(--color-surface-container-lowest)] p-6 rounded-2xl border border-[var(--color-border-subtle)] hover:border-[var(--color-primary)] hover:shadow-lg transition-all group">
            <div className="flex items-center gap-4">
