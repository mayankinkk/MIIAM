...
const service = { label: "AC Repair", icon: "ac_unit", color: "text-blue-500", bg: "bg-blue-50" };
...
export default function ACServicePage() {
  ...
  const mockData = [
    { id: "ACR001", service: "AC Repair", status: "completed", amount: 1200, customer: "John Doe" },
    { id: "ACR002", service: "AC Repair", status: "in_progress", amount: 1500, customer: "Sarah Smith" },
    { id: "ACR003", service: "AC Repair", status: "pending", amount: 800, customer: "Mike Ross" },
    { id: "ACR004", service: "AC Repair", status: "completed", amount: 2000, customer: "Anna Lee" },
    { id: "ACR005", service: "AC Repair", status: "cancelled", amount: 600, customer: "Tom Hardy" },
  ];
    ...
    <div className="px-8 space-y-12">
        ...
        {[
          ...
          <div key={idx} className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-xs font-bold px-2 py-1 rounded-full bg-green-50 text-green-600">{kpi.trend}</span>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-500 to-blue-400 rounded-3xl p-6 text-white shadow-lg">
            <h3 className="font-bold text-lg mb-2">{service.label} Stats</h3>
            <p className="text-white/80 text-sm mb-4">View detailed analytics.</p>
            <button className="w-full py-3 bg-white text-blue-500 rounded-xl font-black text-xs hover:bg-opacity-90 transition-all uppercase tracking-widest">
              View Analytics
            </button>
          </div>
