...
export default function AdminServiceDetail({ params }: { params: { service: string } }) {
  const service = serviceDetails[params.service] || serviceDetails["cleaning"];
  ...
  const mockData: ServiceData[] = [
    { id: "CLN001", service: "Cleaning", status: "completed", amount: 1500, customer: "John Doe", date: "2 hours ago" },
    { id: "CLN002", service: "Cleaning", status: "in_progress", amount: 2000, customer: "Sarah Smith", date: "4 hours ago" },
    { id: "CLN003", service: "Cleaning", status: "pending", amount: 800, customer: "Mike Ross", date: "1 day ago" },
    { id: "CLN004", service: "Cleaning", status: "completed", amount: 2500, customer: "Anna Lee", date: "1 day ago" },
    { id: "CLN005", service: "Cleaning", status: "cancelled", amount: 1200, customer: "Tom Hardy", date: "2 days ago" },
  ];
