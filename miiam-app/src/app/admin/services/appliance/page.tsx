...
export default function AdminServiceDetail({ params }: { params: { service: string } }) {
  const service = serviceDetails[params.service] || serviceDetails["appliance"];
  ...
  const mockData: ServiceData[] = [
    { id: "APR001", service: "Appliance", status: "completed", amount: 600, customer: "John Doe", date: "2 hours ago" },
    { id: "APR002", service: "Appliance", status: "in_progress", amount: 900, customer: "Sarah Smith", date: "4 hours ago" },
    { id: "APR003", service: "Appliance", status: "pending", amount: 450, customer: "Mike Ross", date: "1 day ago" },
    { id: "APR004", service: "Appliance", status: "completed", amount: 1200, customer: "Anna Lee", date: "1 day ago" },
    { id: "APR005", service: "Appliance", status: "cancelled", amount: 350, customer: "Tom Hardy", date: "2 days ago" },
  ];
