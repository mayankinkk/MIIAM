...
export default function AdminServiceDetail({ params }: { params: { service: string } }) {
  const serviceKey = params?.service || "plumbing";
  const service = serviceDetails[serviceKey] || serviceDetails.plumbing;
  ...
  const mockData: ServiceData[] = [
    { id: "PLU001", service: "Plumbing", status: "completed", amount: 800, customer: "John Doe", date: "2 hours ago" },
    { id: "PLU002", service: "Plumbing", status: "in_progress", amount: 1200, customer: "Sarah Smith", date: "4 hours ago" },
    { id: "PLU003", service: "Plumbing", status: "pending", amount: 500, customer: "Mike Ross", date: "1 day ago" },
    { id: "PLU004", service: "Plumbing", status: "completed", amount: 1500, customer: "Anna Lee", date: "1 day ago" },
    { id: "PLU005", service: "Plumbing", status: "cancelled", amount: 400, customer: "Tom Hardy", date: "2 days ago" },
  ];
