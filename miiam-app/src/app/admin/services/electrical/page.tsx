...
export default function AdminServiceDetail({ params }: { params: { service: string } }) {
  const service = serviceDetails[params.service] || serviceDetails["electrical"];
  ...
  const mockData: ServiceData[] = [
    { id: "ELC001", service: "Electrical", status: "completed", amount: 500, customer: "John Doe", date: "2 hours ago" },
    { id: "ELC002", service: "Electrical", status: "in_progress", amount: 800, customer: "Sarah Smith", date: "4 hours ago" },
    { id: "ELC003", service: "Electrical", status: "pending", amount: 350, customer: "Mike Ross", date: "1 day ago" },
    { id: "ELC004", service: "Electrical", status: "completed", amount: 900, customer: "Anna Lee", date: "1 day ago" },
    { id: "ELC005", service: "Electrical", status: "cancelled", amount: 300, customer: "Tom Hardy", date: "2 days ago" },
  ];
