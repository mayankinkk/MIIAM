  ...
  return (
    <>
      <header className="fixed top-0 w-full z-50 flex items-center px-6 py-4 bg-surface/80 backdrop-blur-2xl shadow-[0px_20px_40px_rgba(77,33,42,0.06)]">
        ...
        <span className="text-xl font-extrabold tracking-tight text-on-surface">Payment Methods</span>
      </header>
      ...
      <main className="pt-32 pb-32 px-6 max-w-2xl mx-auto flex flex-col items-center justify-center text-center min-h-[70vh]">
        <div className="w-24 h-24 bg-secondary-container rounded-full flex items-center justify-center mb-6 shadow-lg shadow-secondary/10">
          <span className="material-symbols-outlined text-5xl text-secondary">payments</span>
        </div>
        <h1 className="text-3xl font-extrabold tracking-tight text-on-surface mb-3">Feature Coming Soon</h1>
        <p className="text-on-surface-variant text-lg max-w-sm">We are integrating secure payment gateways to let you manage your saved cards and wallets. Stay tuned!</p>
      </main>
    </>
  );
}
