            ...
            >
              ...
              <div className="flex">
                <div className="w-32 h-32 flex-shrink-0 overflow-hidden bg-slate-100">
                  <img
                    src={restaurant.image_url || restaurant.image || "/images/food_hero.png"}
                    alt={restaurant.shop_name || restaurant.name}
                    className="w-full h-full object-cover"
                    onError={(e) => {
                ...
                <div className="p-4 flex-1">
                  <h3 className="font-bold text-slate-800 text-base">{restaurant.shop_name || restaurant.name}</h3>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-lg overflow-hidden bg-slate-100 flex-shrink-0">
                        <img
                          src={item.image_url || item.image || "/images/food_hero.png"}
                          alt={item.name}
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            (e.target as HTMLImageElement).style.display = "none";
