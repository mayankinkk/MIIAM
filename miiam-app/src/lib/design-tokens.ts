export const colors = {
  ...
  surface: {
    ...
    subtle: 'var(--color-surface-container-lowest)',
    subtleHover: '#ffecee',
    variant: 'var(--color-surface-container)',
    container: '#ffecee',
    containerHover: 'var(--color-surface-container)',
  },
  dark: {
    surface: '#1a0f12',
    surfaceHover: '#24020a',
  ...
  text: {
    ...
    onSurfaceVariantDark: 'var(--color-outline-variant)',
  },
  border: {
    subtle: '#e5e7eb',
