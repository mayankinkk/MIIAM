...
export function VendorCardSkeleton() {
  return (
    <div className="bg-[var(--color-surface-container-lowest)] rounded-2xl overflow-hidden border border-slate-100">
...
export function MenuItemSkeleton() {
  return (
    <div className="flex gap-4 p-4 bg-[var(--color-surface-container-lowest)] rounded-xl border border-slate-100">
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-[var(--color-surface-container-lowest)] rounded-2xl overflow-hidden border border-slate-100">
      ...
      <div className="space-y-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex gap-4 p-4 bg-[var(--color-surface-container-lowest)] rounded-xl border border-slate-100">
...
export function OrderSkeleton() {
  return (
    <div className="p-6 bg-[var(--color-surface-container-lowest)] rounded-xl border border-slate-100 space-y-4">
...
export function ProfileSkeleton() {
  return (
    <div className="bg-[var(--color-surface-container-lowest)] rounded-xl p-6 border border-slate-100">
    ...
    <div className="min-h-screen bg-[#fff8f7] pb-24">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="flex gap-3 overflow-hidden">
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex-shrink-0 w-36 bg-[var(--color-surface-container-lowest)] rounded-2xl overflow-hidden border border-slate-100">
      ...
      <div className="px-4 pb-4">
        ...
        <div className="space-y-3">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex gap-3 bg-[var(--color-surface-container-lowest)] rounded-2xl overflow-hidden border border-slate-100 p-3">
